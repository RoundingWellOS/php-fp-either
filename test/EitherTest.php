...
class EitherTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $count = (new \ReflectionMethod('PhpFp\\Either\\Constructor\\Left::either'))->getNumberOfParameters();
        $this->assertEquals($count, 2, 'Left::either takes two parameters.');
        $count = (new \ReflectionMethod('PhpFp\\Either\\Constructor\\Right::either'))->getNumberOfParameters();
        $this->assertEquals($count, 2, 'Right::either takes two parameters.');
    }
